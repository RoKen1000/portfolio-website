            ...
            <motion.div
                ...
                >
                    ...
                    <div className="about-container">
                        ...
                        <p>As part of the course <strong>I worked on several Full-Stack projects</strong> which can be read about in the Portfolio section of this site. Having graduated from the boot camp <strong>I am now eagerly searching for my first Software Development role. I am based in the East Midlands (Kettering) but I am open to opportunities further afield. </strong> In the meantime I am further developing the skills taught to me on the bootcamp and <strong>I am expanding my knowledge and experience in Full-Stack development.</strong></p>
