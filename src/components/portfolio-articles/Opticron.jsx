        ...
        <main className="portfolio-article-page">
            ...
            >
                ...
                <article>
                    ...
                    <p>The project also makes use of the front-end libraries Foundation Framework and Slick.js. The carousel effect of Slick.js is used to animate and cycle through the various different categories and their associated images. Foundation Framework's grid system was used to responsively space the various articles and special offers found in the main page.</p> 
                    <p>The database was set up using a code-first design paradigm. There are class objects for the categories, articles and special offers which then are used to make up the various SQL tables.</p>
                </article>
